var ATversion='Zek v4.5.0',atscript=document.getElementById('AutoTrimps-script'),basepath='http://fattredd.com/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
